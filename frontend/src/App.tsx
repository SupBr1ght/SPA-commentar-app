...
export default function App() {
  ...
  useEffect(() => {
    ...
    const fetchComments = async () => {
      try {
        const res = await fetch(`https://${import.meta.env.VITE_API_URL}/comments/post/${postId}/comments`);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await fetch(`https://${import.meta.env.VITE_API_URL}/comments`, {
        method: 'POST',
        body: formData,
      });
